function [nlogL] = likelihoodFit2(sigma_m,sigma_p,sigma_s,trialNum,endpts,expData,t,distTestEndpts,lookUpTab,maxDistAll,sigPmax,distFromTarget,endPtsFB,target1,reaches,indicated)
